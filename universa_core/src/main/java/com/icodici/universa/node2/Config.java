...
public class Config {
    ...
    private Duration pollTime = Duration.ofMillis(5000);
    private Duration consensusReceivedCheckTime = Duration.ofMillis(5000);
    private Duration maxConsensusReceivedCheckTime = Duration.ofMinutes(15);
    private Duration resyncTime = Duration.ofMillis(5000);

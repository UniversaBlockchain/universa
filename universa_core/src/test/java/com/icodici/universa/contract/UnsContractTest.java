...
public class UnsContractTest extends ContractTestBase {
    ...
    public void goodUnsContract() throws Exception {
        ...
        assertEquals(uns.getUnsName(reducedName).getUnsNameReduced(), reducedName);
    ...
    public void serializeUnsContract() throws Exception {
        ...
        assertEquals(((UnsContract)desUns).getUnsName(reducedName).getUnsNameReduced(), reducedName);
        ...
        assertEquals(((UnsContract)copiedUns).getUnsName(reducedName).getUnsNameReduced(), reducedName);

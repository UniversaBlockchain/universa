...
public class TestBoss {
	...
	public void testArrays() {
		Object[] data = new Object[] { 0, true, false, 1.0, -1.0, "hello!" };
		assertArrayEquals(data, (Object[]) Boss.load(Bytes
		...
		iarray.add(1);
		iarray.add(2);
		assertArrayEquals( iarray.toArray(), (Object[]) Boss.load(Bytes.fromHex("26 50 A0 08 10")) );
		assertEquals("26 50 A0 08 10", Boss.dump(iarray).toHex());
		
		byte[] ba = new byte[] { 0, 1, 2, 3, 4, 5};
		byte[][] bb = new byte[][] { ba, ba };
		
		Object[] x = (Object[]) Boss.load(Boss.dump(bb));
		assertEquals(2, x.length);
		assertArrayEquals(ba, ((Bytes)x[0]).toArray());
		assertArrayEquals(ba, ((Bytes)x[1]).toArray());
	}
	...
	public void testCache() {
		Object[] res = (Object[]) Boss.load(Bytes
				.fromHex("36 2B 48 65 6C 6C 6F 2B 57 6F 72 6C 64 15 15 15 1D"));
		...
		Object[] sub = new Object[] { "Hello", 1, 2 };
		Object[] a = new Object[] { 10, null, sub, "Hello", null, sub, sub };

		Bytes packed = Boss.dump(a);
		assertEquals("3E 50 05 1E 2B 48 65 6C 6C 6F 08 10 1D 05 15 15",
				packed.toHex());

		assertArrayEquals(a, (Object[]) Boss.load(packed));
